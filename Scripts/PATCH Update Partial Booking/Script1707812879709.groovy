...
response = WS.sendRequestAndVerify(findTestObject('Booking/Update Partial Booking'))

WS.verifyElementPropertyValue(response, 'firstname', "Rex")
WS.verifyElementPropertyValue(response, 'lastname', "Master")